...
Der Parameter \textbf{filter:v} erhält als Werte drei mal \textbf{transpose=1}, damit wird die Eingabe drei mal im Urhzeigersinn gedreht, da es um 90 Grad im Uhrzeigersinn gedreht am Server ankommt. %TODO: warum 3 mal drehen wenn einmal reichen sollte? oder sind es 270 Grad?
