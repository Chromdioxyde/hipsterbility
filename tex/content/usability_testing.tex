...
Testperson, Testbenutzer oder Tester werden auch gleichbedeutend verwendet.
...
\begin{description}
	...
	\item[ToDo] (auch Todo oder TODO), wird eine Standardaufgabe genannt. Eine Session kann mehrere Todos enthalten, welche wiederum in kleinere Teilaufgaben gegliedert werden (Task).
